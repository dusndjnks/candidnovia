const Banner = () => {
    return (
      <div className="relative w-full h-screen">
        <img src="https://lh3.googleusercontent.com/p/AF1QipNdF_MUxpL_1T2f39-09cMLmkjz_BuGa13FFuFS=s870-k-no" alt="" className="absolute inset-0 w-full sm:h-full h-[400px] object-cover"/>        

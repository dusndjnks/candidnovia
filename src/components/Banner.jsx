const Banner = () => {
    return (
      <div className="relative w-full h-[500px]">
        <img src="https://lh3.googleusercontent.com/p/AF1QipNdF_MUxpL_1T2f39-09cMLmkjz_BuGa13FFuFS=s870-k-no" alt="" className="absolute inset-0 w-full sm:h-full h-[500px] object-cover"/>        
        <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        <div className="relative z-10 flex flex-col top-40 h-full text-white text-center px-4">
